...
public class T265Camera1 {
    ...
    static {
        try {
            ...
            // best option.
            Runtime.getRuntime().addShutdownHook(new Thread(T265Camera1::cleanup));
     ...
     */
    public T265Camera1(Transform2d robotOffset, double odometryCovariance, Context appContext) {
     ...
     * T265Camera1#exportRelocalizationMap(String)}. You will have to call {@link T265Camera#free()}
